    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="relative h-screen">
        <div 
          ...
          style={{
            backgroundImage: 'url("https://images.unsplash.com/photo-1579871494447-9811cf80d66c?ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80")',
          }}
        >
        ...
        <nav className="relative z-10 flex items-center justify-between px-6 py-4 text-white">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <a href="#about" className="hover:text-gold-400 transition">À propos</a>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
          ...
          <p className="text-xl md:text-2xl font-light mb-8 max-w-2xl">
            Une expérience gastronomique japonaise d'exception
          </p>
          <a 
            href="#reservation" 
      ...
      <section id="about" className="py-20 px-6 bg-neutral-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl mb-12 text-center font-light">NOTRE HISTOIRE</h2>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <p className="text-gray-600 leading-relaxed">
                Depuis 2015, Sushi d'Or vous propose une expérience culinaire unique au cœur de la ville. 
                Notre chef exécutif, formé à Tokyo, marie avec passion les techniques traditionnelles 
                japonaises aux saveurs contemporaines.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Chaque plat est préparé avec des ingrédients soigneusement sélectionnés, 
                importés directement du Japon ou sourcés localement auprès de producteurs de confiance.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl mb-12 text-center font-light">NOS SPÉCIALITÉS</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              {
                image: "https://images.unsplash.com/photo-1615361200141-f45040f367be?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
